package com.tugasakhir.photographerbooking.view.client.fragment.profile
 ...
 */
class ClientProfileFragment(val user: User) : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.clientName.text = user.fullname
